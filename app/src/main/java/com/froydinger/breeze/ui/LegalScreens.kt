...
fun TermsOfServiceScreen(onBack: () -> Unit) {
    LegalDocumentScreen(
        ...
        sections = listOf(
            LegalSection("Using Breeze", "You may use Breeze to browse the web, manage browser data, use Nav, and set reminders. Use the app lawfully, protect access to your device and account, and do not interfere with the app or its services."),
            ...
            LegalSection("Nav and AI responses", "Nav uses AI services and may return inaccurate, incomplete, or outdated information. Sources may be shown when available; check important claims yourself. Do not rely on Nav for emergencies or as a substitute for professional medical, legal, or financial advice."),
